describe("Utilities test (with setup and tear-down)", function() {
    ...
    it('should sum total tip amount with sumPaymentTotal()', function () {
    ...
    it('should sum total bill amount with sumPaymentTotal()', function () {
    ...
    it('should sum total tip percent with sumPaymentTotal()', function () {
